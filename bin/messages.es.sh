...
MSG_EXPORT_BAD_LAYOUT_FMT="❌ FEATURE_TRACKER_MD_EXPORT_LAYOUT inválida: %s. Debe ser 'flat' o 'nested'."
MSG_EXPORT_CLEANED_FMT="🧹 Eliminados %d archivo(s) obsoleto(s) antes de regenerar."
MSG_EXPORT_CLEAN_WARN="⚠️  No se pudo escanear el export dir completo para limpiar archivos obsoletos. Pueden quedar YYYY-MM-DD-*.md viejos — bórralos manualmente. Causa:"
